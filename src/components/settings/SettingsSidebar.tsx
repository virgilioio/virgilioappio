...
export function SettingsSidebar({ currentTab, onTabChange, className }: SettingsSidebarProps) {
  ...
  const [platformOpen, setPlatformOpen] = useState(
    ['platform-dashboard', 'platform-settings', 'platform-advertising', 'platform-legal', 'platform-countries', 'platform-templates', 'platform-worker-compliance'].includes(currentTab)
  )
