...
export function Header() {
  ...
  return (
    <header className={cn(
      "hidden sm:block fixed top-0 right-0 left-0 sm:left-[4.75rem] z-50 border-b border-virgilio-border transition-shadow supports-[backdrop-filter]:bg-surface-primary/60 bg-surface-primary/90 backdrop-blur",
