...
import { Home, TrendingUp, BarChart3, LogOut, Settings } from 'lucide-react'
...
export function MobileBottomNav() {
  ...
  return (
    <div className="sm:hidden fixed bottom-0 left-0 right-0 z-50 border-t border-virgilio-border bg-surface-primary/95 backdrop-blur supports-[backdrop-filter]:bg-surface-primary/60"
