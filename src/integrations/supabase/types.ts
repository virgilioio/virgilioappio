  ...
  public: {
    Tables: {
      ...
      ai_conversations: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_conversations_sourcing_project_id_fkey"
      ...
      candidate_sources: {
        ...
        Relationships: [
          {
            foreignKeyName: "candidate_sources_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      deal_payments: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "deal_payments_invoice_id_fkey"
            columns: ["invoice_id"]
            isOneToOne: false
            referencedRelation: "deal_invoices"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      job_suggested_candidates_cache: {
        ...
        Relationships: [
          {
            foreignKeyName: "job_suggested_candidates_cache_candidate_id_fkey"
            columns: ["candidate_id"]
            isOneToOne: false
            referencedRelation: "candidates"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "job_suggested_candidates_cache_job_id_fkey"
            columns: ["job_id"]
            isOneToOne: false
            referencedRelation: "jobs"
            referencedColumns: ["id"]
