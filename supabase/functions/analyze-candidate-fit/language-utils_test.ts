...
Deno.test("language rewriting cannot alter Gio Fit scoring invariants", () => {
  const canonical = {
    ...
    profile_summary: "A focused operator.",
    executive_summary: "Strong signal and a risk.",
    dimensions: [{ name: "Skills Alignment", score: 82, weight: 30, verdict: "Strong", insight: "English", matches: ["Match"], gaps: ["Gap"] }],
  ...
  const translatedAttempt = {
    ...
    profile_summary: "Una operadora enfocada.",
    executive_summary: "Señal fuerte y un riesgo.",
    dimensions: [{ name: "Alineación", score: 10, weight: 99, verdict: "Fuerte", insight: "Español", matches: ["Coincidencia"], gaps: ["Brecha"] }],
  ...
  assertEquals(rewritten.profile_summary, translatedAttempt.profile_summary);
