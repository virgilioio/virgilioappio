...
const TOOL_SCHEMA = {
  ...
  function: {
    ...
    parameters: {
      ...
      required: ["overall_score", "confidence", "confidence_reason", "executive_summary", "dimensions", "validation_points", "data_sources_used", "data_sources_missing", "detected_languages"],
      additionalProperties: false,
    },
  },
};
