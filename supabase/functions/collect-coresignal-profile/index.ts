    ...
    EdgeRuntime.waitUntil(
      (async () => {
        try {
          ...
          const profileSummaryMarkdown = await generateProfileSummaryFromCoreSignal(profile);
          const profileSummaryHtml = convertMarkdownToHtml(profileSummaryMarkdown);
          console.log('✅ [Background] Profile summary generated and converted to HTML');

          console.log('🤖 [Background] Processing skills with AI...');
          const skillsPayload = {
            profileSummary: profileSummaryMarkdown,
