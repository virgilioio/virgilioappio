...
BEGIN
  ...
  IF rows_affected = 0 THEN
    INSERT INTO public.platform_feature_flags (flag_name, is_active)
    VALUES (flag_name_param, is_active_param);
  END IF;
...
WHERE flag_name = 'self_serve_admin_enabled' AND description IS NULL;