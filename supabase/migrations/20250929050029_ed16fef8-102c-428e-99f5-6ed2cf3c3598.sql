-- Fix activate_platform_asset function to work without constraint deferring
-- Replace the problematic constraint deferring approach with a simple two-step process
